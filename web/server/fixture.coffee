...
if Envs.find().count() is 0
  dockerDefaultImages = [
    ...
    {_id:"c3h3/learning-shogun:u1404-ocv", type:"ipynb", pictures:["/images/ipynb_sudoku.png"]},
    ...
    {_id:"c3h3/dsc2014tutorial:last", type:"rstudio", pictures:["/images/rstudio_docker_default.png"]},
